...
let musicAlbums = ref([
  { id: 1, image: require('../assets/pictures/playlists/1.jpg'), name: '歌单 1' },
  { id: 2, image: require('../assets/pictures/playlists/2.jpg'), name: '歌单 2' },
  { id: 3, image: require('../assets/pictures/playlists/3.jpg'), name: '歌单 3' },
  { id: 4, image: require('../assets/pictures/playlists/1.jpg'), name: '歌单 1' },
  { id: 5, image: require('../assets/pictures/playlists/2.jpg'), name: '歌单 2' },
  { id: 6, image: require('../assets/pictures/playlists/3.jpg'), name: '歌单 3' },
  { id: 7, image: require('../assets/pictures/playlists/1.jpg'), name: '歌单 1' },
  { id: 8, image: require('../assets/pictures/playlists/2.jpg'), name: '歌单 2' },
  { id: 9, image: require('../assets/pictures/playlists/3.jpg'), name: '歌单 3' },
  { id: 10, image: require('../assets/pictures/playlists/1.jpg'), name: '歌单 1' },
  { id: 11 ,image: require('../assets/pictures/playlists/2.jpg'), name: '歌单 2' },
  { id: 12, image: require('../assets/pictures/playlists/3.jpg'), name: '歌单 3' },
    // 更多歌单
]);
...
<template>
  <nav class="main-menu resizable-box" :style="{ width: sideBarWidth + 'px'}">
    ...
    :style="{ scrollbarWidth : hoverOnAlbum? 'auto':'none'}">
        ...
        <div v-for="album in musicAlbums.values()"
             :key="album.id"
          ...
          <div  class="musicAlbum-description">
            <p style="padding-bottom: 5px;font-size: 18px">{{ album.name }}</p>
