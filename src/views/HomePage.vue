      ...
      <div class="left-content" :class="{ 'expanded': !showRightContent }">
        ...
        <div class="album-details" v-if="album_selected" style="
          ...
          <div class="details-text">
            ...
            <p style="text-align: left; margin-left: 20px">Lorem ipsum dolor sit amet, consectetur adipisicing elit.
              Eius ipsa, praesentium. Aliquid blanditiis excepturi, expedita fugiat illum iure labore nulla placeat
              quasi quidem ratione rem reprehenderit tempore temporibus voluptate voluptatum?</p>
          </div>
        </div>
      </div>
